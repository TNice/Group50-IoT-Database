...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-link">|</li>
    <li class="nav-item">
      <a class="nav-link" <?php if(basename($_SERVER['PHP_SELF']) == 'packages.php'){echo "class='active'";}?> href="packages.php">Packages</a>
    </li>
    <li class="nav-link">|</li>
    <li class="nav-item">
      <a class="nav-link" <?php if(basename($_SERVER['PHP_SELF']) == 'findDevice.php'){echo "class='active'";}?> href="findDevice.php">Find Devices</a>
    </li>
    <li class="nav-link">|</li>
    <li class="nav-item">
